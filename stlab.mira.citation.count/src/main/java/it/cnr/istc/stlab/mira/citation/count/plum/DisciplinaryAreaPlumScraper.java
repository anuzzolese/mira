package it.cnr.istc.stlab.mira.citation.count.plum;
        			...
        			if(disciplinaryAreaFolder.exists() && disciplinaryAreaFolder.isDirectory()){
        				...
        				files.parallelStream().forEach(rdfFile -> {
        					...
        					try {
								...
								BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter(new File(jsonDaOutFolder, rdfFile.getName().replace(".ttl", ".json"))));
								try {
